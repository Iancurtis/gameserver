 ...
 *@author woko
 */
public class tbllog_buy extends BaseLog{
	/***所属平台***/
	...
	/***寄卖品价格货币类型(铜钱/元宝/…) (1=金币，2=绑定金币，3=铜币，4=绑定铜币)***/
	...
	public tbllog_buy(String platform, Integer sales_id, Long role_id, Integer item_id, Integer price_type, Integer price_unit, Long item_number, Integer action_id, Integer happend_time, Integer log_time){
		this.platform = platform;
		this.sales_id = sales_id;
		this.role_id = role_id;
		this.item_id = item_id;
