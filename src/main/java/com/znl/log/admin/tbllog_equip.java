 ...
 *@author ad
 */
public class tbllog_equip extends BaseLog{
	/***所属平台***/
	...
	/***对应各自项目组的装备消耗项目字典，行为类型（dict_action.action_id)***/
	...
	public tbllog_equip(String platform, Long role_id, String account_name, Integer dim_level, Integer opt, Integer action_id, Integer type_id, Long equip_id, Integer happend_time, Integer log_time) {
		this.platform = platform;
		this.role_id = role_id;
		this.account_name = account_name;
		this.dim_level = dim_level;
