 ...
 *@author woko
 */
public class tbllog_ordnancepice extends BaseLog{
	/***所属平台***/
	...
	public tbllog_ordnancepice() {
	}


	public tbllog_ordnancepice(String platform, Long role_id, String account_name, Integer dim_level, Integer opt, Integer action_id, Integer type_id, Long item_number, Integer map_id, Integer happend_time, Integer log_time) {
		this.platform = platform;
		this.role_id = role_id;
		this.account_name = account_name;
		this.dim_level = dim_level;
