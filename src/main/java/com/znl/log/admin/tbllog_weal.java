 ...
 *@author woko
 */
public class tbllog_weal extends BaseLog{
	/***所属平台***/
	...
	/***福利类型（登录/充值/手工等）***/
	private Integer weal_type = 0 ;
	public Integer getWeal_type(){
	  return weal_type;
	}
	public void setWeal_type(Integer weal_type){
	this.weal_type = weal_type;
	}
	...
	/***在一次获得福利时获得多个物品时，可以通过json的格式记录在该字段中，而此时，item_id与item_number留空***/
	...
	public tbllog_weal(String platform, Long role_id, String account_name, Integer weal_type, Integer item_id, Long item_number, Integer money_type, Long amount, String source_data, Integer happend_time, Integer log_time){
		this.platform = platform;
		this.role_id = role_id;
		this.account_name = account_name;
		this.weal_type = weal_type;
