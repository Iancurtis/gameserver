...
public class Buff1082 extends Buff {

    public Buff1082 (PuppetEntity role) {
       super(role);//增加己方所有部队30点穿刺
   ...
   public void onOccur() {
           ...
           super.modifyAttr(SoldierDefine.POWER_wreck, value+3000, false, 0);
           super.onOccur();}
