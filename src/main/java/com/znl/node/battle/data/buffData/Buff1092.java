...
public class Buff1092 extends Buff {

    public Buff1092 (PuppetEntity role) {
       super(role);//减少敌方所有部队10%伤害
   ...
   public void onOccur() {
           ...
           super.modifyAttr(SoldierDefine.POWER_damadd, value-1000, false, 0);
           super.onOccur();}
