...
public class Buff1054 extends Buff {

    public Buff1054 (PuppetEntity role) {
       super(role);//增加己方所有部队20%暴击
   ...
   public void onOccur() {
           ...
           super.modifyAttr(SoldierDefine.POWER_critRate, value+2000, false, 0);
           super.onOccur();}
