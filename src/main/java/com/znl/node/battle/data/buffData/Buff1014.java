...
public class Buff1014 extends Buff {

    public Buff1014 (PuppetEntity role) {
       super(role);//增加己方所有部队20%伤害
   ...
   public void onOccur() {
           ...
           super.modifyAttr(SoldierDefine.POWER_damadd, value+2000, false, 0);
           super.onOccur();}
