...
public class Buff1055 extends Buff {

    public Buff1055 (PuppetEntity role) {
       super(role);//增加己方所有部队25%暴击
   ...
   public void onOccur() {
           ...
           super.modifyAttr(SoldierDefine.POWER_critRate, value+2500, false, 0);
           super.onOccur();}
