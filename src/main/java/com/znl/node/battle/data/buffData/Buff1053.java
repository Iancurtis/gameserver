...
public class Buff1053 extends Buff {

    public Buff1053 (PuppetEntity role) {
       super(role);//增加己方所有部队15%暴击
   ...
   public void onOccur() {
           ...
           super.modifyAttr(SoldierDefine.POWER_critRate, value+1500, false, 0);
           super.onOccur();}
