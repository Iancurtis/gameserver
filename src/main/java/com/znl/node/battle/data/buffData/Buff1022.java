...
public class Buff1022 extends Buff {

    public Buff1022 (PuppetEntity role) {
       super(role);//减少敌方所有部队20%命中
   ...
   public void onOccur() {
           ...
           super.modifyAttr(SoldierDefine.POWER_hitRate, value-2000, false, 0);
           super.onOccur();}
