...
public class Buff1102 extends Buff {

    public Buff1102 (PuppetEntity role) {
       super(role);//增加己方所有部队20%闪避
   ...
   public void onOccur() {
           ...
           super.modifyAttr(SoldierDefine.POWER_dodgeRate, value+2000, false, 0);
           super.onOccur();}
