...
public class Buff1011 extends Buff {

    public Buff1011 (PuppetEntity role) {
       super(role);//增加己方所有部队5%伤害
   ...
   public void onOccur() {
           ...
           super.modifyAttr(SoldierDefine.POWER_damadd, value+500, false, 0);
           super.onOccur();}
